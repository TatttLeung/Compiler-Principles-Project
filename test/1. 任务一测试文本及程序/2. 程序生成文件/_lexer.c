...
int main(int argc, char* argv[]) {
	FILE* input_fp = fopen("F:/个人资料/学习/计算机大三/2024 编译原理课程项目/上交材料/2. 测试文件夹/1. 任务一测试文本及程序/2. 程序生成文件/_sample.tny", "r");
	if (input_fp == NULL) {
		printf("Failed to open input file");
		return 1;
	}
	FILE* output_fp = fopen("F:/个人资料/学习/计算机大三/2024 编译原理课程项目/上交材料/2. 测试文件夹/1. 任务一测试文本及程序/2. 程序生成文件/output.lex", "w");
	if (output_fp == NULL) {
